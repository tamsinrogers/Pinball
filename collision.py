...
collision_router[ ('newshape', 'ball') ] = collision_ball_ball
collision_router[ ('newshape', 'block') ] = collision_ball_block
collision_router[ ('newshape', 'triangle') ] = collision_ball_block                                                                   

def collision(newshape, thing, dt):
	key = (newshape.getType(), thing.getType())
	func = collision_router[key]
	func(newshape, thing, 0.1)
